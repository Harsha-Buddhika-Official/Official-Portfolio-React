      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8">
          <div className="mb-8 md:mb-0 max-w-md">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-accent-400 to-primary-400 bg-clip-text mb-4">
              Harsha Buddhika
            </h2>
            <p className="text-gray-400 mb-6">
              Undergraduate student at Eastern University focusing on Software
              Engineering, UI/UX Designing, and Full Stack Development.
            </p>
        ...
        <div className="mt-10 pt-8 flex flex-col md:flex-row md:justify-between md:items-center relative">
          ...
          <div className="mt-4 md:mt-0">
            ...
            >
              Back to top
              <svg
                className="ml-1 w-4 h-4 group-hover:-translate-y-1 transition-transform"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
